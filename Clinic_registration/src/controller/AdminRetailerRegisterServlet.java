...
@WebServlet("/AdminRetailerRegisterServlet")
@MultipartConfig(fileSizeThreshold=1024*1024*2, // 2MB
maxFileSize=1024*1024*10,      // 10MB
maxRequestSize=1024*1024*50)
public class AdminRetailerRegisterServlet extends HttpServlet {
	...
	
	{
			 ...
			 response.sendRedirect("AdminRetailer_Registration.jsp?er="+error); 
		 }	
