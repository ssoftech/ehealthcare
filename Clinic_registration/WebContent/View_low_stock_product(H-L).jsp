...
String sql = "select r2.Medicinename, r2.quantity, r1.Price from retailer r1 INNER JOIN low_stock_product r2 ON r1.medicinename=r2.medicinename INNER JOIN retailer_detail r3 ON r2.Retailername=r3.Retailername where r3.Email=? ORDER BY r1.Price DESC LIMIT 10";
