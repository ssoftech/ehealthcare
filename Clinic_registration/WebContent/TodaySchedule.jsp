<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="db.DB" import="java.sql.Connection"  import="java.time.*"
...
<script src="CSS1/jquery.datetimepicker.min.js" type="text/javascript" charset="utf-8"></script>
     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			...
			String username = (String)session.getAttribute("fname");
			   if(username==null)
			   {
				  response.sendRedirect("Dummy_Login.jsp");
			   }
...
String sql1 = "select * from doctor_scheduler where date=? AND docemail=?";
