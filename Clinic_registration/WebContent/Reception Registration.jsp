...
<span><h5 style="margin-top: 15%;"><font color = white>welcome &nbsp;&nbsp; <%=username%></font></h5></span>
      ...
      <div class="copy">
		<form action="receptionReg_serv" method="post" >
<div class="container-fluid">
    <h2>Reception Registration Form</h2>
	<div class="col-md-12">
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<input type="text" name="Recepname" placeholder="Enter Name Here.." class="form-control1" required />
