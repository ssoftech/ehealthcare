...
<span><h5 style="margin-top: 15%;"><font color = white>welcome &nbsp;&nbsp; <%=username%></font></h5></span>
  ...
  if(ar!=null)
  {%><form action="upsateServlet" method="post" enctype="multipart/form-data">
...
function readURL(input) {
      ...
      <input type="text" class="form-control1" name="Address" value="<%=bn.getAddress()%>"/>
      ...
      <input type="text" class="form-control1" name="Mobile" value="<%=bn.getMobile()%>"/>
