...
<nav class="navbar navbar-default navbar-static-top navbar-fixed-top">
	...
	<th class="text-center"><b>Doctor Name</b></th>
	<th class="text-center"><b>Registration Id</b></th>
	<th class="text-center"><b>Degree </b></th>
	<th class="text-center"><b>Specilization </b></th>
	<th class="text-center"><b>Experience </b></th>
	<th class="text-center"><b>Address</b></th>
	<th class="text-center"><b>Phone No. </b></th>
...
{%>
		<tr class="bg-info">
	 <td hidden><b><%=rs.getString("id") %>.</b></td>
	 ...
	 <td><img src="images/<%=rs.getString("Image")%>" width="50px" height="50px"/></td>
