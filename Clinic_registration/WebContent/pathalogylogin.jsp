...
<body>
    <div class="container"> 
    <form action="pathalogyLoginServlet" method="post" >   
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title">Sign In</div>
                        <div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="pathresetpassword.jsp">Forgot password?</a></div>
                    </div>     
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 control">
                                        ...
                                        <a href="pathalogy registration.jsp" onClick="$('#loginbox').hide(); $('#signupbox').show()">
                                            Sign Up Here
                                        </a>
                                        </div>
                                    </div>
