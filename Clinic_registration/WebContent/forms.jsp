...
<%
			...
			if (email != "" || email != null) {
				...
				String sql = "Select fname from customer_reg where email=?";
		...
		%>
			...
			{
			if(cookies1[j].getName().equals("PasswordName"))
			//out.println("Hello"+cookies[i].getValue());
				passwordID = cookies[j].getValue();
	

			}
		
			System.out.println("Email ID from Cookie : "+EmailID);
			System.out.println("Password from Cookie : "+passwordID);
			
			
			
				System.out.println("Username is " + session.getAttribute("fname"));
			%>
...
<div id="wrapper">
             ...
             <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="login.html"><i class="glyphicon glyphicon-off nav_icon"></i>Logout</a>
                        </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
    ...
    <div class="content_bottom">
      <div class="clearfix"> </div>
		...
		<div class="copy">
          <p>Copyright &copy; 2015 SSTL. All Rights Reserved | Design by <a href="http://sehrishsoftech.com/" target="_blank">SSTL</a> </p>
	    </div>
		</div>
       </div>
      <!-- /#page-wrapper -->
