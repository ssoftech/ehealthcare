...
var vis=document.getElementById("divvis");
...
<form action="HeaderFooter" method="post">
     ...
     try{
			...
			String sql9 = "Select * from size";
			PreparedStatement ps9 = con.prepareStatement(sql9);
			
			ResultSet rs9 = ps9.executeQuery();
			while (rs9.next()) {
				Hdr = rs9.getString("Header");
				System.out.println(Hdr);
				Ftr = rs9.getString("Footer");
				System.out.println(Ftr);
				Page = rs9.getString("Print");
				System.out.println(Page);
			}
			}catch(Exception e){System.out.println(e);}

     if(Page.equals("DoctorPrescription"))
     {
     %>
     
     	 <input type="radio" name="print" value="DoctorPrescription"  onclick="chk1()" checked> Print With Design
     	 <input type="radio" name="print" id="Nodes" value="DoctorPreswithoutdesign" onclick="chk()"> Print Without Design
    
     	 <%}
     else{ %>
     <input type="radio" name="print" value="DoctorPrescription"  onclick="chk1()" > Print With Design
     	 <input type="radio" name="print" id="Nodes" value="DoctorPreswithoutdesign" onclick="chk()" checked> Print Without Design
     	  

     	      <%
     	      } %>
     <div id="divvis" style="visibility: hidden;">
    <table><tr> Headder: <input type="text" name="Header" value="<%=Hdr %>" style="width: 50px;">px &nbsp;&nbsp;&nbsp;&nbsp;
     Footer: <input type="text" name="Footer" value="<%=Ftr %>" style="width: 50px;">px</tr>
     <br>
     <br>
     ...
     <table> <tr align="center"> <input type="submit" name="Bnt" value="Submit" ></tr></table>
