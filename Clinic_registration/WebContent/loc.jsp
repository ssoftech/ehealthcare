...
function fun(str) {
	  ...
	  xhttp.open("POST", "state1.jsp?s="+str, true);
	  xhttp.send();
	}
function fun11(str) {
	   var xhttp;
	  ...
	  xhttp.open("POST", "city1.jsp?s="+str, true);
	  xhttp.send(); 
	}
function fun22(str) {
	   var xhttp;
	  ...
	  xhttp.onreadystatechange = function() {
	    if (xhttp.readyState == 4 && xhttp.status == 200) {
	      document.getElementById("specialization").innerHTML = xhttp.responseText;
	    }
	  };
	  xhttp.open("POST", "specialization1.jsp?s="+str, true);
	  xhttp.send(); 
	}
</script>
</head>
...
<span><h5 style="margin-top: 15%;"><font color = white>welcome &nbsp;&nbsp; <%=username%></font></h5></span>
			    ...
			    <li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="m_2"><a href="Address.jsp"><i class="fa fa-user"></i> ADD Address</a></li>
						<li class="m_2"><a href="update.jsp"><i class="fa fa-wrench"></i> Settings</a></li>
...
<form action="SpcilisationServlet" method="post">
...
<select class="form-control1" name="specialization" >
<option value="select">select</option>
</select>
</div>
</div>
...
System.out.println("ssssss");
  ...
  <th>Contact</th>
...

     {
		  ...
		  %>
<tr><td><img src="images/<%=ad.getFile()%>" height="100" width="100"></img></td>
