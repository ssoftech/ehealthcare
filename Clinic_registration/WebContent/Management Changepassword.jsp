...
function fun(str) {
	  ...
	  xhttp.onreadystatechange = function() {
	    if (xhttp.readyState == 4 && xhttp.status == 200) {
	      document.getElementById("pdr").innerHTML = xhttp.responseText;
	      
	    }
	  };
	  xhttp.open("POST", "Managementuser.jsp?s="+str, true);
	  xhttp.send();
	}
</script>
</head>
...
<span><h5 style="margin-top: 15%;"><font color = white>welcome &nbsp;&nbsp; <%=username%></font></h5></span>
    ...
    <div class="container-fluid">
     <form action="ManagementupdateServlet" method="post" >
     <div class="row">
     <div class="col-md-12">
      <label for="sel1">user id</label>
<select name="userid" class="form-control1" onchange="fun(this.value)">
<option value="selec">user id</option>
<%
