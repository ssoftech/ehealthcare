...
<%
String med = request.getParameter("s2"); 
System.out.println("medicine name is"+med);
%>
<div class="row">
<div class="col-md-12">
...
<div class="col-md-2"> Medicine Name</div>
      <div class="col-md-8"> <input type="text" name="medicinename" id="medicinename" value="<%=med %>" placeholder="enter medicine name you want to delete" style="width: 600px;"/></div>
      <div class="col-md-2"><input type="submit" name="Delete" id="Delete" value="Delete" /></div>
</div>
</div>
</div>
</div>
