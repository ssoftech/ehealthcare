        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        ...
                        <div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="Doc_ForgotPassword.jsp">Forgot password?</a></div>
                    </div>     
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form">
                        	...
                        	<div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input id="login-userid" type="text" class="form-control" name="docid" value="" placeholder="Doctor ID">                                        
                                    </div>
