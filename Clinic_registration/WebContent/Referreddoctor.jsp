...
<span><h5 style="margin-top: 15%;"><font color = white>welcome &nbsp;&nbsp; <%=username%></font></h5></span>
 ...
 <form action="RefdocServlet" method="post" >
  <input type="hidden" name="pathalogyname" value=<%=username%>  />
              <div class="row text-left">
      <div class="col-md-6">
      <label><span class="label label-primary">Name of the Doctor </span></label>
      <input type="text" class="form-control1" name="doctorName" placeholder="Enter Name of doctor" required />
      </div>
      <div class="col-md-6">
      <label><span class="label label-primary">Registration ID</span></label>
      <input type="text" class="form-control1" name="registrationid" placeholder="Enter registration id" required />
      </div>
      </div>
        <br></br>
             <div class="row text-left"> 
             <div class="col-md-6">
              <label><span class="label label-primary">Specilization </span></label>
...
<option value="Surgeon">Surgeon</option>
              ...
              <div class="col-md-6">
      <label><span class="label label-primary">Date</span></label>
      <input type="text" class="form-control1" name="date" placeholder="Enter Test Date" value="<%=currentDate %>" readonly="readonly" />
      </div>
      </div>
                 <div class="row">
      <div class="col-md-10">
