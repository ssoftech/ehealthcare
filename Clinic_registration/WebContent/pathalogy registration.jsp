...
function validateEmail() {
	...
	var url;
	url= "pathalogymailcheck.jsp?email="+email;
...
<form action="pathalogyServlet" method="post" enctype="multipart/form-data" >
<div class="container">
				...
				<form>
						...
						<div class="row">
							<div class="col-sm-12 form-group">
								...
								<input type="text" name="pathalogyname" placeholder="Enter Pathalogy Name Here.." class="form-control" required />
					...
					<div class="row">
						...
						<input type="text" name="Email" placeholder="@example.com" id="email" class="form-control" onblur="validateEmail(this.value)" required/>
                        <input type="hidden" name="user" id="user" value="Pathology">
  ...
  <div class="col-md-12">
    <div class="input-group">
      ...
      <input id="MOBILE_NO" name="mobile" class="form-control" placeholder="Enter Your Mobile Number " type="text" required="">
    </div>
...
<input id="uploadFile" type="file" style="width:95px;" name="file" class="img"  />
  <script type="text/javascript">
