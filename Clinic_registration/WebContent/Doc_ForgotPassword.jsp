...
function mailcheck() {
	...
	var url;
	url= "Doc_EmailChecking2.jsp?Email="+email;
...
function mobilecheck() {
	...
	if(email.length==0)
		{
		document.getElementById("alert1").innerHTML = "please enter mobile no.";
		}
	else
		{
   var xhttp = new XMLHttpRequest();
	var url;
	url= "DocEmailChecking3.jsp?Mob="+mob;
	  xhttp.onreadystatechange = function() {
	    if (xhttp.readyState == 4 && xhttp.status == 200) {
	      document.getElementById("alert1").innerHTML = xhttp.responseText;
...
<body>
    <div class="container"> 
  <form action="Doc_NewFile1.jsp" method="post"> 
  ...
  <br></br>
 						...
 						<div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input id="mob" type="text" class="form-control" name="mobile" placeholder="Enter Your valid Mobile No" onkeyup="mobilecheck()" />                                        
                                    </div>
                     <div id="alert1" align="center" style="color: red;"></div>
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <a id="btn-back" href="Doctor_Login.jsp" class="btn btn-primary">Back  </a>
