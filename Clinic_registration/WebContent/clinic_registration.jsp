...
<form action="clinicServlet" method="post" enctype="multipart/form-data" >
<div class="container">
				...
				<form>
						...
						<div class="row">
							<div class="col-sm-12 form-group">
								...
								<input type="text" name="clinicname" placeholder="Enter First Name Here.." class="form-control" required />
					...
					<div class="row">
                       ...
                       <input type="hidden" name="user" id="user" value="Clinic">
