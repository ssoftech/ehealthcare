...
<div class="col-md-2"> Medicine Name</div>
     <div class="col-md-8"> <input type="text" name="medicinename" id="medicinename" value="<%=med %>" placeholder="enter medicine name you want to edit" style="width: 600px;"/></div>
      <div class="col-md-2"> <input type="submit" name="Edit" id="Edit" value="Edit" /></div>
</div>
</div>
</div>
</div>
