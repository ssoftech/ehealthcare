<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="Model.DAO1,bean.viewpath_DoctorBean"  import="Model.DAO"%>
<!DOCTYPE HTML>
<html>
<head>
...
function fun(str) {
	  ...
	  xhttp.onreadystatechange = function() {
	    if (xhttp.readyState == 4 && xhttp.status == 200) {
	      document.getElementById("pdri").innerHTML = xhttp.responseText;
	      
	    }
	  };
	  xhttp.open("POST", "pathology_doctor_reg_id.jsp?s="+str, true);
	  xhttp.send();
	}
function fun1(str,str1) {
	  ...
	  xhttp.onreadystatechange = function() {
	    if (xhttp.readyState == 4 && xhttp.status == 200) {
	      document.getElementById("pd").innerHTML = xhttp.responseText;
	    }
	  };
	  xhttp.open("POST", "pathology_doctor.jsp?s="+str+"&s1="+str1, true);
	  xhttp.send();
	}
	</script>
	...
	function show(str) {
		  ...
		  xhttp.open("POST", "count.jsp?s="+str, true);
		  xhttp.send();
		}
	function show1(str) {
		  ...
		  xhttp.open("POST", "amount.jsp?s="+str, true);
		  xhttp.send();
		}
...
<div class="form-group">
      <label for="sel1">Specilazation</label>
<select name="country" class="form-control1" onchange="fun(this.value)">
<option value="selec">select Specilazation</option>
<%
Connection con=DB.dbcon();
if(con!=null)
{
String sql="select distinct Specilization from  referred where pathalogyname=?";
...
<div class="form-group" id="pdri">
      <label for="sel1">Registration ID</label>
<select class="form-control1" name="Reg_id" >
...
<select class="form-control1" name="doctor" >
<option value="select">select</option>
</select>
</div>
</div>
