 ...
 //  properties.setProperty("mail.smtp.host", host);
  ...
  // Session mailSession = Session.getDefaultInstance(properties);
   ...
   try{
      ...
      message.setContent("Hi Here is your password resetting link. Click on the link to reset your password. "+"<a href='http://localhost:8080/Clinic_registration/ResetPassword1.jsp'>CLICK HERE</a>",
                            "text/html" );
      // Send message
