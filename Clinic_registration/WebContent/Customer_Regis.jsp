...
<form action="Customer_regisServ" method="post" enctype="multipart/form-data" >
<div class="container">
	...
	<div class="row">
	  	 ...
	  	 <option value="Others">Others</option>
						...
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								...
								<input type="password" name="password" placeholder="Enter confirm Password Here.." id="cnfpass"  class="form-control" onblur="return validateCnfPassword(this.value);" required>
      	 ...
      	 <option value="">select</option>
						...
						<div class="row">
							<div class="col-sm-12 form-group">
								<label>Zipcode</label>
								<input type="text" name="zipcode" placeholder="Enter Zipcode Here.." class="form-control" required>
							</div>		
							</div>	
						<div class="row">						
					<div class="col-sm-12 form-group">
						<label>Phone Number</label>
						<input type="text" name="MOBILE" placeholder="Enter Phone Number Here.." class="form-control" required>
					</div>
                    </div>
                    <div class="row">
