...
<%@page import="bean.Patient"  import="Model.DAO"%>
...
<span><h5 style="margin-top: 15%;"><font color = white>welcome &nbsp;&nbsp; <%=username%></font></h5></span>
      ...
      <div class="copy">
      <form action="patientschedule" method="Post">
      <div class="container">
...
<input type="text" name="doctorname" class="form-control1" placeholder="Enter Doctor name"/>
</div>
...
<input type="text" type="text" name="registrationid" class="form-control1" placeholder="Enter Your Registrationid"/>
</div>
</div>
</div>
</div>
...
System.out.println("ssssss");
  ...
  { 
	  ...
	  %><table border="1px" cellpadding="20px" align="center" style="border: solid #39DFFB;"><tr  bgcolor="AliceBlue"><th>Patient Name</th><th>Age</th><th>DISEASE</th><th>Mobile No</th><th>Print</th></tr>
...
<td><a href="showPatient.jsp?">Print Here</a></td>
<%}}
