...
<head>
	...
	<script src="../CSS1/dhtmlxscheduler.js" type="text/javascript" charset="utf-8"></script>
	<link rel="stylesheet" href="../CSS1/dhtmlxscheduler.css" type="text/css" media="screen" title="no title" charset="utf-8">
	<script src="../CSS1/dhtmlxscheduler_limit.js" type="text/javascript" charset="utf-8"></script>
...
/* 		scheduler.attachEvent("onTemplatesReady", function() {
	...
	// var s= scheduler.getEvent(e);
       ...
       <% String email=(String)session.getAttribute("email"); %>
		...
		scheduler.init('scheduler_here',new Date(today.toString()),"month");
		
		scheduler.load("./data/<%=email%>scheduleevent.xml");
