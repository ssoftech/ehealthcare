...
<%@page import="java.sql.*,bean.Pathalogy,Model.*,java.util.*,java.util.Date"%>
<!DOCTYPE HTML>
<html>
<head>
...
function show_Date()
{
	...
	document.getElementById("TEST_DATE").value=new Date();
...
<span><h5 style="margin-top: 15%;"><font color = white>welcome &nbsp;&nbsp; <%=username%></font></h5></span>
 ...
 <form action="test_categoryServ" method="POST">
  <input type="hidden" name="pathalogyname" value=<%=username%>  />
  <input type="hidden" name="email" value="<%=email%>"/>
<fieldset>
            <div class="form-group"> 
              <label class="control-label">Test Name</label>
              <input type="text" class="form-control1"name="NAME_OF_TESTS"  placeholder="enter your Test Name" required>
            </div>
             <div class="form-group"> 
              <label class="control-label">Test Date</label>
              <input type="text" class="form-control1" name="TEST_DATE" value="<%=new Date()%>" readonly="readonly">
            </div> 
<div class="form-group">
      ...
      <div>
           ...
           <table class="table text-center"  rules="all" style="border: 1px solid #000;">
        <thead>
        		  <tr  class="bg-primary"> <th><b>NAME_OF_TESTS</b></th>
</tr>
    </thead>
     <%try
{
