...
<form action="updateTest_serv" method="POST" >
<table class="table text-left"  rules="groups">
<% String TEST_SUBCATEGORY_NAME=request.getParameter("tid");
System.out.println("Its is in edit1.jsp"+TEST_SUBCATEGORY_NAME);
Connection con=DB.dbcon();
String sql="Select TEST_SUBCATEGORY_NAME,DETAILS,SPECIMEN,METHOD,PRICE,RULES,AVAILABILITY,DISTANCE from test_subcategory where TEST_SUBCATEGORY_NAME=?";
...
%>
 <div class="row">
      <div class="col-md-12">
      <label><span class="label label-primary">TEST_SUBCATEGORY_NAME</span></label>
<input type="text" class="form-control1" name="TEST_SUBCATEGORY_NAME" value="<%=TEST_SUBCATEGORY_NAME%>" readonly="readonly" >
 </div>
   </div>
    <br></br>
<div class="row">
      <div class="col-md-12">
      <label><span class="label label-primary">DETAILS</span></label>
<input type="text" class="form-control1" name="DETAILS" value="<%=rs.getString("DETAILS") %>"  >
</div>
   </div>
<br></br>
<div class="row">
      <div class="col-md-12">
      <label><span class="label label-primary">SPECIMEN</span></label>
<input type="text" class="form-control1" name="SPECIMEN" value="<%=rs.getString("SPECIMEN")%>"  >
</div>
   </div>
<br></br>
<div class="row">
      <div class="col-md-12">
      <label><span class="label label-primary">METHOD</span></label>
<input type="text" class="form-control1" name="METHOD" value="<%=rs.getString("METHOD") %>"  >
</div>
   </div>
<br></br>
<div class="row">
...
<input type="text" class="form-control1" name="PRICE" value="<%=rs.getDouble("PRICE") %>">
</div>
   </div>
<br></br>
<div class="row">
      <div class="col-md-12">
      <label><span class="label label-primary">RULES</span></label>
<input type="text" class="form-control1" name="RULES" value="<%=rs.getString("RULES") %>" >
</div>
   </div>
<br></br>
<div class="row">
      <div class="col-md-12">
      <label><span class="label label-primary">AVAILABILITY</span></label>
<select  class="form-control1" name="AVAILABILITY" value="<%=rs.getString("AVAILABILITY") %>">
<option value=""><%=rs.getString("AVAILABILITY") %></option>
...
<div class="row">
      <div class="col-md-12">
      <label><span class="label label-primary">DISTANCE</span></label>
<input type="text"  class="form-control1" name="DISTANCE" value="<%=rs.getString("DISTANCE") %>"  readonly="readonly">
</div>
   </div>
       <div class="row">
      <div class="col-md-12">
