...
<input type="text" name="name" value="<%=username %>" hidden="name">
  <h3>
   Post your Add
  </h3>
  <textarea name="area2" style="width: 700px; height: 400px;"  required /><p align="left">
       </p></textarea>

<br><br />
<input style="background-color: purple; width: 100px; height: 60px;" type="submit" name="Submit" value="submit">
