...
System.out.println("From Prescription page without design  mobile: "+Pmobile);
String Pmobile1=request.getParameter("pmobile1");
		...
		try {
			...
			String sql1 = "Select * from patients_appointment where MobileNo=?";
			PreparedStatement ps1 = con.prepareStatement(sql1);
			ps1.setString(1, Pmob);
			ResultSet rs1 = ps1.executeQuery();
			while (rs1.next()) {
				ADDRESS = rs1.getString("ClinicAdd");
				CName = rs1.getString("ClinicName");
				CPh = rs1.getString("ClinicPh");
			}
	...
	<form action="PreviewPrescriptionWithoutDesign.jsp">
		<div id="apDiv1" >
			<div id="apDiv2"
				...
				<div id="apDiv3" >
					<table>
						<tr>
							<td>B.p:</td>
							<td><input type="text" name="P_BP" style="width: 50px;"
						...
						<tr>
							<td>Pulse:</td>
							<td><input type="text" name="P_Pls" style="width: 50px;"
								onkeypress="return validateDec(event)"></td>
							<td>BPM</td>
						</tr>
					</table>
					...
					<table>
						...
						<tr>
							<td>Test:</td>
							<td><textarea rows="5" cols="12" autocomplete="off"
								name="P_Test"	id="textarea_autocomplete_field"></textarea> <!-- <input type="text" name="P_Test" id="textarea_autocomplete_field" style="width: 120px;height: 50px;" > -->
							</td>
						</tr>
					</table>
				</div>
				...
				<div id="apDiv4" >
					<table align="center" cellpadding="10px">
						...
						<tr>
							<td>NAME:</td>
							<td><input type="text" readonly="readonly" name="P_Name"
								style="width: 170px;" value="<%=PName%>"></input></td>
							<td></td>
							<td>AGE:</td>
							<td><input type="text" name="P_Age" readonly="readonly"
								style="width: 50px;" value="<%=PAge%>"></input></td>
							<td>SEX:</td>
							<td><input type="text" name="P_Sex" readonly="readonly"
								style="width: 50px;" value="<%=PSex%>"></input></td>
						</tr>

						<tr>
							<td>Disease:</td>
							<td><textarea type="text" name="P_Dses"
									style="width: 170px; height: 50px;"><%=Pdses%></textarea></td>
